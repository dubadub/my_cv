...
%---------------------------------------------------------
    ...
    {Cloud-based testing platform with 3000+ types of varieties devices and browsers. Over 50,000 customers in 135 countries including Microsoft, Twitter, and AirBnB.} % About Org
    ...
    {Cloud-based platform for connecting companies and investors for direct meetings online, a Silicon Valley-owned company} % About Org
